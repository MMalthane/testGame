...
function Summary(props){
    ...
    if(result.tie){
        ...
        <div className="row summary"> 
            <div className="alert col-12 alert-info  mt-2"> Its a Draw !! </div>
            </div>
        )
    }else{
        if(result.win === 'X'){
            const player = players.p1 ==='X' ? 'Player 1' : 'Player 2'
         return  <div className="alert summary  col-12 alert-success  mt-2"> {player} WINS!! </div> 
    ...
    return  (
        <div className="row summary mt-4 p-md-0">
